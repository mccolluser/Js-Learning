window.addEventListener("DOMContentLoaded", function () {
    ...
    myform.addEventListener('submit', function (event) {
        ...
        postData(formData)
            .then(() => {loadGif.style.display = 'block'; loadGif.setAttribute('src', newMessage.loading)})
            .then(() => {loadGif.style.display = 'block';loadGif.setAttribute('src', newMessage.success)})
            .catch(() => {loadGif.style.display = 'block';loadGif.setAttribute('src', newMessage.failure)})
            .then(clearInput);
